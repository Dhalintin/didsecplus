...
const contact_route_1 = __importDefault(require("./contact/routes/contact.route"));
const mail_route_1 = __importDefault(require("./mail/routes/mail.route"));
